...
# This used to have "target" instead of "jar", the jar file needs to be included with the package.
_gateway_path: Path = _script_path / "jar" / "bc-python-port-1.0-SNAPSHOT-jar-with-dependencies.jar"
